...
public class ArithmeticTest {
    ...
    private ExecutionEngine getExecutionEngine() {
        return new VirtualMachine(500, 50, 10000, false).getEngine();
    }

    @Test
    public void divide() {
        byte[] byteCode = {ICONST_5.b(), ICONST_3.b(), IDIV.b(), IRETURN.b()};
        long res = getExecutionEngine().invoke(new Method("", "", "", 0, byteCode, 2, 0));
        assertEquals(1, res);

        byte[] byteCode2 = {ICONST_2.b(), ICONST_2.b(), IDIV.b(), IRETURN.b()};
        res = getExecutionEngine().invoke(new Method("", "", "main:()V", 0, byteCode2, 2, 0));
        assertEquals(1, res);

        byte[] byteCode3 = {BIPUSH.b(), (byte) 17, BIPUSH.b(), (byte) 5, IREM.b(), IRETURN.b()};
        res = getExecutionEngine().invoke(new Method("", "", "main:()V", 0, byteCode3, 2, 0));
        assertEquals(2, res);
    }
    ...
    public void addAndMultiply() {
        ...
        res = getExecutionEngine().invoke(new Method("", "", "", 0, byteCode2, 2, 0));
        assertEquals(0, res);

        byte[] byteCode3 = {ICONST_2.b(), ICONST_M1.b(), IMUL.b(), IRETURN.b()};
        res = getExecutionEngine().invoke(new Method("", "", "", 0, byteCode3, 2, 0));
        assertEquals(-2, res);
    }
    ...
    public void increment() {
        ...
        long res = getExecutionEngine().invoke(new Method("", "", "", 0, byteCode, 1, 6));
    ...
    public void dupX1() {
        ...
        long res = getExecutionEngine().invoke(new Method("", "", "", 0, byteCode, 3, 0));
        assertEquals(5, res);

        byte[] byteCode2 = {ICONST_1.b(), ICONST_2.b(), DUP_X1.b(), IADD.b(), DUP_X1.b(), IADD.b(), IADD.b(), IRETURN.b()};
        res = getExecutionEngine().invoke(new Method("", "", "", 0, byteCode2, 3, 0));
        assertEquals(8, res);
    }
